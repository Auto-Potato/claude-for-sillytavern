...
test('welcome creation never loads old chat or emits synthetic native events',async()=>{
 ...
 const host=new Function('st','group','accountStorage','createChatActions','getChatCompletionModel','createOperationLock','document','MutationObserver',source+';return host;')(st,group,{},()=>({}),()=>null,createOperationLock,{getElementById:()=>null},class {observe(){} disconnect(){}});
